...
def main(sc, files):
    for file in files:
        # Leer el archivo y procesar las aristas
        edges_rdd = sc.textFile(file).map(process_edge).distinct()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("python3 3_triciclo_local.py <grafo_1/n> <grafo_2/n> ... <grafo_n/n>")
